package com.github.drepic26.couponcodes.canary.listeners;
...
public class CanaryListener implements CommandListener {
	...
	public void couponCommand(MessageReceiver caller, String[] parameters) {
		if (caller instanceof net.canarymod.api.entity.living.humanoid.Player) {
			...
			handleCommandEvent(com.github.drepic26.couponcodes.api.command.Command.Sender.PLAYER, player, sb.toString());
		}
	}

	private boolean handleCommandEvent(com.github.drepic26.couponcodes.api.command.Command.Sender type, Player sender, String message) {
